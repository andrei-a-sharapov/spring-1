...
@ContextConfiguration(classes = {AppConfiguration.class, DataSourceConfiguration.class, DbSessionFactory.class, lab1.beans.configuration.TestAuditoriumConfiguration.class})
@Transactional
