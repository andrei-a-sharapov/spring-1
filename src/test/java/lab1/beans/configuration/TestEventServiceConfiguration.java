...
import lab1.beans.models.Rate;
import lab1.beans.services.EventService;
import lab1.beans.services.EventServiceImpl;
...
public class TestEventServiceConfiguration extends TestAuditoriumConfiguration {
    ...
    public Event testEvent1() {
        return new Event("Test event", lab1.beans.models.Rate.HIGH, 124.0, java.time.LocalDateTime.of(2016, 2, 6, 14, 45, 0),
                         testHall1());
    }
