...
import lab1.beans.daos.AuditoriumDAO;
import lab1.beans.daos.BookingDAO;
import lab1.beans.daos.EventDAO;
import lab1.beans.daos.UserDAO;
import lab1.beans.daos.mocks.*;
import lab1.beans.models.*;
import lab1.beans.services.*;
import lab1.beans.services.discount.BirthdayStrategy;
import lab1.beans.services.discount.DiscountStrategy;
...
public class TestBookingServiceConfiguration {
    ...
    public Event testEvent1() {
        return new Event(1, "Test event", lab1.beans.models.Rate.HIGH, 124.0, java.time.LocalDateTime.of(2016, 2, 6, 14, 45, 0),
                         testHall1());
    }
